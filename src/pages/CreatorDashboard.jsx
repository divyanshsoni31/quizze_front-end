    ...
    >
      ...
      <div className="text-white pt-4 pb-3 px-4" style={{ background: 'linear-gradient(to right, #015794, #437FAA)', borderBottomLeftRadius: '80px', borderBottomRightRadius: '80px', width: '100%', zIndex: 1 }}>
        <div className="container d-flex justify-content-between align-items-start">
          ...
          <div>
            <a href="/" className="text-white fw-bold me-3" style={{ fontSize: '1.1rem' }}>Home</a>
            <a href="#" className="text-white fw-bold me-3" style={{ fontSize: '1.1rem' }}>Create Quiz</a>
            <a href="#" className="text-white fw-bold" style={{ fontSize: '1.1rem' }}>View Quizzes</a>
          </div>
        </div>
      ...
      <div className="container flex-grow-1 d-flex justify-content-center align-items-center flex-wrap gap-4 mt-5">
        ...
        <div className="bg-white shadow p-4 text-center rounded" style={{ width: '300px', minHeight: '200px' }}>
          ...
          <p>Manage every Quizzes that you made.</p>
          <button className="btn btn-secondary px-4">View Quizzes</button>
        </div>

        <div className="bg-white shadow p-4 text-center rounded" style={{ width: '300px', minHeight: '200px' }}>
          <h3 className="fw-bold">Quiz Results</h3>
          <p>Check scores and performance analytics</p>
          <button className="btn btn-success px-4">View Results</button>
        </div>
      </div>
